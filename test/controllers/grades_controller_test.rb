...
class GradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grade" do
    assert_difference("Grade.count") do
      post grades_url, params: { grade: { australian: @grade.australian, french: @grade.french, yosemite: @grade.yosemite } }
    end
  ...
  test "should update grade" do
    patch grade_url(@grade), params: { grade: { australian: @grade.australian, french: @grade.french, yosemite: @grade.yosemite } }
